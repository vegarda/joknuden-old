...
function alertSchema(warningText, warningLevel, warningHeader){
    ...
    alertDiv.style = 'position: relative; overflow: hidden;';
    if (warningLevel == 2){
    ...
    warningYrSpan.style = 'font-size: 10px; float: right; position: relative; top: 5px;';
    ...
    $.ajax({
        ...
        success: function(galedata){
			...
			if (warnings.length > 0){
				...
				var firstLocation = warnings[0].attributes["name"].value;
