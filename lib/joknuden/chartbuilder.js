...
$(function() {
    ...
    $.ajax({
        ...
        success: function(chartdata){
            ...
            var pointInterval = ((chartdata.dateTime[chartdata.dateTime.length - 1] - chartdata.dateTime[0])/(chartdata.dateTime.length -1)) * 1000;
                ...
                window['rainChart'] = new Highcharts.Chart(
                    chartConfig('rainChart', 400, 
                                ...
                                [seriesSchema('Rain Rate', 'rainRate', 'spline', Highcharts.getOptions().colors[1], Highcharts.getOptions().colors[1], 0, chartdata.rainRate, 1.5, {enabled: false}, 'Dash', ' mm/hr', 1),
                                 seriesSchema('Accumulated Rain', 'dayRain', 'areaspline', Highcharts.getOptions().colors[0], Highcharts.getOptions().colors[0], 1, chartdata.accumRain, 1.5, {enabled: false}, null, ' mm', 1)]));
            }, 2000);
