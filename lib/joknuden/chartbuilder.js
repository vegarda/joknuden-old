...
$(function() {
    ...
    $.ajax({
        ...
        success: function(chartdata){
            ...
            var pointInterval = Math.round((pointEnd - pointStart)/chartdata.dateTime.length);
            ...
            setTimeout(function(){                           
                window['humidityChart'] = new Highcharts.Chart(
                    chartConfig('humidityChart', 400, 
                                ...
                                [seriesSchema('Humidity', 'outHumidity', 'spline', '#596FF0', '#596FF0', 0, chartdata.outHumidity, 1.5, {enabled: false}, 'ShortDot', '%', 0)]));
            }, 1750);
                ...
                window['rainChart'] = new Highcharts.Chart(
                    chartConfig('rainChart', 400, 
                                [yAxisSchema(' mm/hr', false, 0, null, 50, null), 
                                 yAxisSchema(' mm', true, 0, null, 10, null)], pointStart, pointInterval,
                                [seriesSchema('Rain Rate', 'rainRate', 'spline', Highcharts.getOptions().colors[1], Highcharts.getOptions().colors[1], 0, chartdata.rainRate, 1.5, {enabled: false}, 'Dash', ' mm/hr', 1),
                                 seriesSchema('Accumulated Rain', 'dayRain', 'areaspline', Highcharts.getOptions().colors[0], Highcharts.getOptions().colors[0], 1, chartdata.rain, 1.5, {enabled: false}, null, ' mm', 1)]));
            }, 2000);
            ...
            setTimeout(function(){                           
				...
				/*new Highcharts.Chart(
                    chartConfig('tempChart', 400, 
                                [yAxisSchema('°C', true, null, null, 5, null)], pointStart, pointInterval,
                                [seriesSchema('Temperature', 'outTemp', 'areasplinerange', '#fa3e3e', '#596FF0', 0, chartdata.outTemp, 1.5, {enabled: false}, null, '°C', 1)]));*/ 
            }, 2250);
        }
    });
